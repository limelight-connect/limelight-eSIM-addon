...
1. **Create a GitHub repository** for the add-on:
   ...
   git remote add origin https://github.com/your-org/esim-platform-ha-addon.git
...
3. **Users can install** by adding the repository URL to Home Assistant:
   ```
   https://github.com/your-org/esim-platform-ha-addon
   ```
...
1. **Push images to registry**:
   ...
   docker tag esim-platform-ha-addon-amd64-1.0.13 your-registry/esim-platform-ha-addon-amd64-1.0.13
   
   # Push to registry
   docker push your-registry/esim-platform-ha-addon-amd64-1.0.13
   ```

2. **Update config.yaml** with registry image names:
   ```yaml
   image: your-registry/esim-platform-ha-addon-{arch}-{version}
   ```
...
1. **Add Repository**:
   ...
   - Add: `https://github.com/your-org/esim-platform-ha-addon`
